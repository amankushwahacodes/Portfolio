...
export default function HireMeButton() {
  ...
  return (
    <div className="fixed top-4 right-4 z-50 hidden md:block">
      <Link
        href="https://drive.google.com/file/d/1TZdLWXpZrXJfxiOTuEX1xGM8sYwnA8YA/view?usp=sharing"
        target="_blank"
      ...
      >
        ...
        >
          <Briefcase className="h-4 w-4 stroke-black dark:stroke-white" />
          <span>Hire Me</span>
          <ChevronDown className="h-3 w-3 stroke-black dark:stroke-white" />
        </Button>
      </Link>
    </div>
  );
